 ...
 *
 * @phpstan-type OutputFunctionToolCallOutputType array{call_id: string, id: string, output: string|array<int, array<string, mixed>>, type: 'function_call_output', status: 'in_progress'|'completed'|'incomplete', caller?: DirectToolCallCallerType|ProgrammaticToolCallCallerType, created_by?: string|null}
 *
 * @implements ResponseContract<OutputFunctionToolCallOutputType>
 */
final class OutputFunctionToolCallOutput implements ResponseContract
{
    /**
     * @use ArrayAccessible<OutputFunctionToolCallOutputType>
     */
    use ArrayAccessible;
    ...
    /**
     * @param  OutputFunctionToolCallOutputType  $attributes
     */
