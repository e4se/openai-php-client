 ...
 *
 * @phpstan-type CustomToolType array{name: string, type: 'custom', defer_loading?: bool, description?: string, format?: CustomToolInputTypes, allowed_callers?: array<int, 'direct'|'programmatic'>}
 *
